...
/**
 * Created by TARIK-ROSC on 1/1/2018.
 */

public class LocationApiActivity extends Activity implements ConnectionCallbacks,
        OnConnectionFailedListener, LocationListener {

    // LogCat tag
    private static final String TAG = LocationApiActivity.class.getSimpleName();
    ...
    private void displayLocation() {
        if (checkPermission()) {
            ...
            requestPermission(LocationApiActivity.this);
        }
    }
